<?php
    ...
    if($_POST["submit"]) {
        ...
        $result='<div class="alert alert-danger"><strong>There were error(s) in your form: </strong>'.$error.'</div>';
            ...
            if(mail("rawwer@gmail.com", "From Lukazorc.io", "Name: ".$_POST['name']."
Email: ".$_POST['email']."
Comment: ".$_POST['comment'])) {
                ...
                $result='<div class="alert alert-danger">Sorry, there was an error with you message. Please try again later.</div>';
            }
        }     
    }
